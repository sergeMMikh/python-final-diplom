...
**Более подробное описание задач можно найти в исходном задании от Нетологии[(README_tasks_description.md)](README_tasks_description.md)**

## Примеры запроса для работы с API
Список запросов к проложению соответствует предложенной [документации по запросам в PostMan](https://documenter.getpostman.com/view/5037826/SVfJUrSc) 
